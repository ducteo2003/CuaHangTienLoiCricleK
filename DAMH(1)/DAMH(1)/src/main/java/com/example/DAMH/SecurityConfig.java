...
public class SecurityConfig {
    private final NHANVIENService userService; // Tiêm UserService vào lớp cấu hình này.
    @Bean // Đánh dấu phương thức trả về một bean được quản lý bởi Spring Context.
    public UserDetailsService userDetailsService() {
        return new NHANVIENService(); // Cung cấp dịch vụ xử lý chi tiết người dùng.
    }
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                ...
                .formLogin(formLogin -> formLogin
                        ...
                        .defaultSuccessUrl("/thongkeTuan") // Trang sau đăng nhập thành công.
